...
tf.app.flags.DEFINE_string('eval_dir', PROJECT_DIR + '/eval',
                            """Directory where to write event logs """)
tf.app.flags.DEFINE_string('checkpoint_path', PROJECT_DIR + + '/data/model_checkpoints/squeezeDet/model.ckpt-400',
