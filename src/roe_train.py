...
from config import *
from dataset import pascal_voc, roe
from utils.util import sparse_to_dense, bgr_to_rgb, bbox_transform
from nets import *

############################### FLAGS ##################################
PROJECT_DIR = "F:/MEGA/THESIS/SOFTWARE/NN/ROE_NN"

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('dataset', 'ROE',
                           """Dataset for ROE robot""")
tf.app.flags.DEFINE_string('data_path', PROJECT_DIR + '/data', """Root directory of data""")
tf.app.flags.DEFINE_string('image_set', 'train',
                           """ Can be train, trainval, val, or test""")
tf.app.flags.DEFINE_string('year', '2007',
                           """VOC challenge year. 2007 or 2012"""
                           """Only used for Pascal VOC dataset""")
tf.app.flags.DEFINE_string('train_dir', PROJECT_DIR + '/train',
                           """Directory where to write event logs """
                           """and checkpoint.""")
tf.app.flags.DEFINE_integer('max_steps', 401,
                            """Maximum number of batches to run.""")
tf.app.flags.DEFINE_string('net', 'squeezeDet',
                           """Neural net architecture. """)
tf.app.flags.DEFINE_string('pretrained_model_path', PROJECT_DIR + '/data/SqueezeNet' + '/squeezenet_v1.1.pkl',
    ...
    try:
        ...
        with tf.Graph().as_default():
            ...
            assert FLAGS.net == 'squeezeDet', \
                'Selected neural net architecture not supported: {}'.format(FLAGS.net) #Only support for squeezeDet
            ...
            imdb = roe(FLAGS.image_set, FLAGS.data_path, mc)
...
from config import *
from dataset import pascal_voc, kitti, roe
from utils.util import sparse_to_dense, bgr_to_rgb, bbox_transform
from nets import *

############################### FLAGS ##################################
PROJECT_DIR = "F:\DATASETS\squeezeDet"

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('dataset', 'ROE',
                           """Dataset por ROE robot""")
tf.app.flags.DEFINE_string('data_path', PROJECT_DIR + '/data', """Root directory of data""")
tf.app.flags.DEFINE_string('image_set', 'train',
                           """ Can be train, trainval, val, or test""")
tf.app.flags.DEFINE_string('year', '2018',
                           """VOC challenge year. 2007 or 2012"""
                           """Only used for Pascal VOC dataset""")
tf.app.flags.DEFINE_string('train_dir', PROJECT_DIR + '/train',
                           """Directory where to write event logs """
...
>>>>>>> master
    #tensorboard --logdir=F:\DATASETS\squeezeDet\train